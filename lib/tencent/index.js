...
const { jsonp, m3u, request } = require('../utils');
...
async function fetch(uri, proxy, validCode = [0]) {
    ...
    const { code, ...data } = jsonp(await request(options));
...
/**
 * 判斷歌曲資源是否可用
 * https://y.gtimg.cn/music/portal/js/common/pkg/common_a3c5637.js?max_age=31536000 (l8564)
 * @param {object} e 歌曲信息
 */
function playable(e) {
